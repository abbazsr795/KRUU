  ...
  // doc.data() is never undefined for query doc snapshots
    ...
    return <>
        <div className="horizontalcenter flexiblerow spacearound">
            ...
            { isempty ? null : <button onClick={()=>{navigate('/vaccines/pastrecords/edit')}} ><div className="verticalcenter card1 grow"><div className="horizontalcenter"><img className='img2' src="https://img.icons8.com/ios/512/plus-2-math.png"/></div><h1 className="midtext">Add Record</h1></div></button> }
        </div>
    </>
}
